...
def readData(filename):
    ...
    for line in reader:
        tempdata = np.array(line[:-1], dtype='float64')
        tempLabel = line[-1]
        if(tempLabel == '1'):
            #插入数据
...
# preWork
#设置区间化水平
randArray = [0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5]
...
dataSet1, labels1, dataSet2, labels2 = readData('/Users/nevin47/Desktop/Project/Academic/Code/Python/SVM/Heart.csv')
